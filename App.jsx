...
const App = () => {
  ...
  return <div className="bg-black text-white h-screen w-full p-3 flex flex-col gap-7 items-center justify-center">
    <h1 className="text-5xl font-bold">Accordian</h1>
    <div className="flex gap-5 flex-col items-center">
      {data.map(({ id, heading, description }) => {
        return <div key={id}
          onClick={() => { handleClick(id) }}
          className="bg-gray-900 text-white border w-3xl p-3 rounded">
